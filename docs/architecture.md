# Architecture — agentcore-sdk

## Overview

Agent substrate: event schemas, identity, telemetry bridge, plugin registry

This document describes the high-level architecture of agentcore-sdk
...
agentcore-sdk uses a decorator-based plugin registry backed by
``importlib.metadata`` entry-points. This allows third-party packages
(including the agentcore enterprise edition) to extend the system
...
from agentcore.core import BaseProcessor  # example base class
