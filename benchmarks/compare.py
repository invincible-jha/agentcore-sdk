"""Comparison visualiser for agentcore-sdk benchmark results."""
...
def main() -> None:
    ...
    result_files = [
        "event_bus_throughput_baseline.json",
        "serialization_throughput_baseline.json",
        "latency_baseline.json",
        "memory_baseline.json",
    ]

    print(f"\n{'=' * 80}")
    print("  agentcore-sdk Benchmark Results")
    print(f"{'=' * 80}")
