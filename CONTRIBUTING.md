# Contributing to agentcore-sdk

Thank you for contributing to agentcore-sdk, part of the AumOS portfolio.
...
```bash
git clone https://github.com/aumos-ai/agentcore-sdk.git
cd agentcore-sdk
pip install -e ".[dev]"
```
